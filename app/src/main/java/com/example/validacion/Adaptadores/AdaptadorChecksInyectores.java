...
public class AdaptadorChecksInyectores extends RecyclerView.Adapter<AdaptadorChecksInyectores.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        try {
            ...
            String ID_check_inyector = jsonObject2.optString("ID_check_inyector", "");
            String valor_check = jsonObject2.optString("valor_check", "");
            String nombre_check = jsonObject2.optString("nombre_check", "");
            String status_revision= jsonObject2.optString("estatus","");
            ...
            holder.buenoRadioButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                  ...
                  //  actionListener.onActualizarCheck(ID_valor_check, "Bueno");
                    ...
                    actionListener.onActualizarCheckInyector( ID_check_inyector, "Bueno");
                }
            });
            ...
            holder.maloRadioButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                  ...
                  //  actionListener.onActualizarCheck(ID_valor_check, "Malo");
                    actionListener.onActualizarCheckInyector( ID_check_inyector, "Malo");
...
actionListener.onActualizarCheckInyector( ID_check_inyector, "Regular");
                }
            });
    ...
    public interface OnActivityActionListener {
        void onActualizarCheckInyector(String ID_check_inyector, String valorCheck);

    }

    private AdaptadorChecksInyectores.OnActivityActionListener actionListener;


    public AdaptadorChecksInyectores(List<JSONObject> data, Context context, AdaptadorChecksInyectores.OnActivityActionListener actionListener) {
        this.data = data;
