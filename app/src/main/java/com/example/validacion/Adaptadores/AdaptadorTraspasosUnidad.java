...
public class AdaptadorTraspasosUnidad extends RecyclerView.Adapter<AdaptadorTraspasosUnidad.ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(String ID_traspaso, String DOCID);  }


    private AdaptadorTraspasosUnidad.OnItemClickListener onItemClickListener;

    public void setOnItemClickListener(AdaptadorTraspasosUnidad.OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        try {
            ...
            String ID_traspaso = jsonObject2.optString("ID_traspaso", "");
            ...
            holder.frameNotas.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (onItemClickListener != null) {
                        ...
                        onItemClickListener.onItemClick(ID_traspaso, DOCID);
                    }
                }
            });
    ...
    public AdaptadorTraspasosUnidad(List<JSONObject> data, Context context) {
