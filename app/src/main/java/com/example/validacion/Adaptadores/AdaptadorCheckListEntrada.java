...
public class AdaptadorCheckListEntrada extends RecyclerView.Adapter<AdaptadorCheckListEntrada.ViewHolder> {
    private Context context;
    private List<JSONObject> producciones;
    private List<JSONObject> filteredData;
    private AdaptadorCheckListEntrada.OnActivityActionListener actionListener;
...
*/
    ...
    public AdaptadorCheckListEntrada(List<JSONObject> data, Context context, AdaptadorCheckListEntrada.OnActivityActionListener actionListener) {
