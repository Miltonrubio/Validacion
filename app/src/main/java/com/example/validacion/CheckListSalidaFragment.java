...
public class CheckListSalidaFragment extends Fragment implements AdaptadorCheckListEntrada.OnActivityActionListener {/* implements AdaptadorChecks.OnCheckUpdatedListener*/
    ...
    public CheckListSalidaFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_check_list_salida, container, false);
